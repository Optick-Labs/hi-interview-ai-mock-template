...
DB_PASSWORD=$(echo "$DATABASE_URL_HI" | awk -F':' '{print $3}' | awk -F'@' '{print $1}')
DB_PORT=$(echo "$DATABASE_URL_HI" | awk -F':' '{print $4}' | awk -F'\/' '{print $1}')
DB_NAME=$(echo "$DATABASE_URL_HI" | awk -F'/' '{print $4}')
